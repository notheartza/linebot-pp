...
def addexam():
    ...
    for i in getsheet:
        ...
        firebase_rdb.child('exam').child('examinations').child('1').child(count).set({"หน่วย": i['หน่วย'], "หัวข้อ": i['หัวข้อ'], "หัวข้อ": i['หัวข้อ'], "คำถาม": i['คำถาม'], "เฉลย": i['เฉลย'], "ตัวเลือ": chice})
        count = count + 1
    """
